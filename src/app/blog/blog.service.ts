...
export class BlogService {
  ...
  listPost: any = [
    ...
    {'id': '1', 'title': 'Lorem ipsum dolor sit amet', 'date': '01/01/2019', 'preview': 'Vestibulum placeratVestibulum placerat posuere urna vel scelerisque.', 'label': [ 'music', 'verse' , 'music', 'photograph'] },
    // tslint:disable-next-line:max-line-length
